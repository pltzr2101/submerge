...
def sync_subtitles(
    ...
    Args:
        ...
        input_path: Path to file to synchronize
        output_path: Output path for synchronized file

    Returns:
        SyncResult with status and output path
    ...
    logger.info(f"Subtitles synchronized: {output_path}")
...
def sync_subtitles_to_video(
    ...
    Args:
        ...
        input_path: Path to subtitle file to synchronize
        output_path: Output path for synchronized file
